-- IMPORTANT: First run this query to generate the bcrypt hash for 'admin123'
-- Or use an online bcrypt generator: https://bcrypt-generator.com/
-- Rounds: 10, Password: admin123
-- The hash will be something like: $2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy
...
-- Password: admin123
-- Use this bcrypt hash (10 rounds): $2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy
-- Or generate your own at: https://bcrypt-generator.com/
INSERT INTO users (email, password, is_admin) 
VALUES ('admin@gmail.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', TRUE);
